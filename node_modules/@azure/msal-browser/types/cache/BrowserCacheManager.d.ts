...
export declare class BrowserCacheManager extends CacheManager {
     ...
     * @param correlationId
     */
    setAuthorityMetadata(key: string, entity: AuthorityMetadataEntity, correlationId: string): void;
    /**
     ...
     * @param generateKey
     */
    getTemporaryCache(cacheKey: string, correlationId: string, generateKey?: boolean): string | null;
    /**
    ...
    cacheAuthorizeRequest(authCodeRequest: CommonAuthorizationUrlRequest, correlationId: string, codeVerifier?: string): void;
    /**
     * Gets the token exchange parameters from the cache. Throws an error if nothing is found.
     * @param correlationId
     */
    getCachedRequest(correlationId: string): [CommonAuthorizationUrlRequest, string];
    /**
    ...
    setInteractionInProgress(inProgress: boolean, type?: INTERACTION_TYPE, allowOverride?: boolean, correlationId?: string): void;
    /**
